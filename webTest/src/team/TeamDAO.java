...
public class TeamDAO {
	...
	public boolean replyCreate(TeamDTO dto) {
		...
		StringBuffer sql = new StringBuffer();
		sql.append(" insert into team(no, name, gender, hobby, skills, phone, zipcode, ");
		sql.append(" address, address2, grpno, indent, ansnum, refnum) ");
	...
	public boolean create(TeamDTO dto) {
		...
		sql.append(" (no, name, gender, hobby, skills ,phone,  ");
		sql.append(" zipcode, address, address2, grpno) ");
		sql.append(" values((select nvl(max(no),0) +1 from team), ");
		sql.append(" ? ,? ,? ,? ,? ,? ,? ,?, ");
