...
<table>
	...
	<tr>
		<th>주소</th>
		<td>
		<input type="text" name="address" size="45"  type="text" id="sample6_address" placeholder="주소"> 
		<input type="text" name="address2" size="45" type="text" id="sample6_address2" placeholder="상세주소"> 		
		</td>
	</tr>	
</table>
<div>
